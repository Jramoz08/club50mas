...
function togglePlayPause() {
  if (video.paused) {
    video.play();
    playPauseBtn.innerHTML = '<img src="assets/video/pause.png" alt="pausa">'; // Imagen de pausa
  } else {
    video.pause();
    playPauseBtn.innerHTML = '<img src="assets/video/play.png" alt="play">'; // Imagen de play
  }
}
